...
sudo pacman -S --noconfirm --needed kitty hyprland waybar hyprlock hypridle awww ttf-font-awesome swaync
...
sudo pacman -S --noconfirm --needed gvfs gvfs-smb samba nvim mpv imv brightnessctl playerctl blueman gnome-text-editor swayimg imagemagick
