...
hl.bind(config.mainMod .. " + F", hl.dsp.window.fullscreen({ mode = "fullscreen" }), { bypass = true })
hl.bind(config.mainMod .. " + SHIFT + F", hl.dsp.window.fullscreen({ mode = "maximized" }), { bypass = true })
hl.bind(config.mainMod .. " + ALT + SPACE", hl.dsp.window.float({ action = "toggle" }), { bypass = true })
...
hl.bind(config.mainMod .. " + G", hl.dsp.exec_cmd(config.browser .. ' --app="https://gemini.google.com/app"'), { bypass = true })
